...
// const genAI = new GoogleGenerativeAI( 'AIzaSyBbzeRME6myonh92UR4rW1YhqL60PooWKE')
...
export const chatController = async (req, res) => {
  try {
    ...
    const systemPrompt = `You are a helpful Safety Assistant specializing in disaster preparedness, emergency response, and safety guidance. ...` // truncated for brevity

    // List of models to try
    const modelNames = ['gemini-2.5-flash', 'gemini-pro', 'gemini-1.5-pro']
    let lastError = null
