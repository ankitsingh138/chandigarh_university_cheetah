...
//     try {
//       const response = await fetch('http://localhost:8000/api/safety-assistant/chat', {
//         method: 'POST',
//         headers: {
  ...
  <div className={`flex ${isUser ? 'justify-end' : 'justify-start'}`}>
    <div
      className={`px-4 py-3 rounded-lg max-w-[80%] ${
        isUser ? 'bg-purple-600 text-white' : 'bg-bg-primary text-text-primary'
      }`}
    >
...
const formatResponse = (rawText) => {
  ...
  // Remove stars or markdown symbols
    ...
    <div className="flex flex-col h-[calc(100vh-8rem)] max-h-[800px]">
      ...
      >
        <div className="flex items-center space-x-3 mb-2">
          ...
          <h1 className="text-4xl font-bold text-purple-500">Safety Assistant</h1>
        </div>
        <p className="text-lg text-text-secondary">
          Your AI-powered assistant for disaster preparedness and emergency response
        </p>
          ...
          {isLoading && (
            <div className="flex justify-start mb-4">
              <div className="bg-bg-primary border border-gray-700 rounded-lg px-4 py-3">
                <div className="flex space-x-2">
                  <div className="w-2 h-2 bg-purple-500 rounded-full animate-bounce"></div>
                  <div className="w-2 h-2 bg-purple-500 rounded-full" style={{ animationDelay: '0.2s' }}></div>
                  <div className="w-2 h-2 bg-purple-500 rounded-full" style={{ animationDelay: '0.4s' }}></div>
                </div>
              </div>
            </div>
          )}
